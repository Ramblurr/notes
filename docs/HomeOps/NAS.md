...
4. Write the new firmware to the flash: `sas2flash.efi -o -f 2118it.bin -b mptsas2.rom`
 ...
 mount
 # the usb stick is probably fs0, ft0, fs0, fst1
 # mount it
 mount fs0:
 # cd into it
 fs0:
 # ls to check if your files are there
 ls
 # 
 ```
...
## IPMI Fan Sensor Control (Supermicro board specific)

```console
# ipmitool sensor |grep FAN
FAN1             | 800.000    | RPM        | ok    | 300.000   | 500.000   | 700.000   | 25300.000 | 25400.000 | 25500.000 
FAN2             | 1400.000   | RPM        | ok    | 300.000   | 500.000   | 700.000   | 25300.000 | 25400.000 | 25500.000 
FAN3             | 600.000    | RPM        | nc    | 300.000   | 500.000   | 700.000   | 25300.000 | 25400.000 | 25500.000 
FAN4             | 1300.000   | RPM        | ok    | 300.000   | 500.000   | 700.000   | 25300.000 | 25400.000 | 25500.000 
FANA             | 500.000    | RPM        | nc    | 300.000   | 400.000   | 700.000   | 25300.000 | 25400.000 | 25500.000 
FANB             | 600.000    | RPM        | nc    | 300.000   | 400.000   | 700.000   | 25300.000 | 25400.000 | 25500.000 

# ipmitool sensor thresh FANB lcr 400
